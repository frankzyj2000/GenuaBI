...
namespace GenuinaBI.Models
{
    ...
    public class DataTableResult<T> where T : class
    {
        ...
        public DataTableResult(int drawflag, int count, List<T> list)
        {
            this.draw = drawflag;
    ...
    public abstract class DataTableRow
    {
        ...
        /// </summary>
        public virtual string DataTableRow_ID
        {
            get { return null; }
        }
        ...
        /// </summary>
        public virtual string DataTableRow_Class
        {
            get { return null; }
        }
        ...
        /// </summary>
        public virtual object DataTableRow_Data
        {
            get { return null; }
        }
    }
